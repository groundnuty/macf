...
program
  ...
  .option('--app-key <path>', 'Source path of the downloaded App private key (.pem) to INGEST into --key-path (default ~/.macf/keys/<agent>.pem) at 0600. Onboarding: create the App -> download the .pem -> macf init --app-key <path> ....')
